...
struct Frame
{
    ...
    static constexpr float SMARTBOMB_ICON_X = 56;
    static constexpr float SMARTBOMB_ICON_Y = 376;
    static constexpr float SMARTBOMB_NAME_READOUT_X = 136;
    static constexpr float SMARTBOMB_NAME_READOUT_Y = 380;
    static constexpr float SMARTBOMB_STATUS_READOUT_X = SMARTBOMB_NAME_READOUT_X;
    static constexpr float SMARTBOMB_STATUS_READOUT_Y = SMARTBOMB_NAME_READOUT_Y + 32;
    static std::string smartbombNameString[Smartbomb::NUM_TYPES];
    static std::string smartbombStatusString;
    ...
    static std::string mainWeaponNameString[PC::NUM_HULL_TYPES];
    ...
    static std::string subshipNameString[Subship::NUM_HULL_TYPES];
